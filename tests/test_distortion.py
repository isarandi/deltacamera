...
class TestBrownConradyRoundtrip:
    ...
    def test_roundtrip_12_param(self, d):
        ...
        valid_region_ud, _ = deltacamera.validity.get_valid_distortion_region(
...
class TestFisheyeRoundtrip:
    ...
    def test_roundtrip(self, d):
        ...
        recovered = deltacamera.distortion.undistort_points_fisheye(
            distorted, d, check_validity=False
        )
...
class TestDistortionEdgeCases:
    ...
    def test_empty_points(self):
        ...
        result = deltacamera.distortion.distort_points(empty, d, check_validity=False)
